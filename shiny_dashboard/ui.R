    ...
    div(
      ...
      div(
        ...
        div(
          ...
          tags$a(
            href = "https://petervitale910.github.io/", target = "_blank",
            tags$img(src = "peter.jpg",    style = "width: 80px; height: 80px; border-radius: 50%; object-fit: cover;")
          ),
          tags$a(
            href = "https://natbonnet.github.io/", target = "_blank",
            tags$img(src = "nathalie.jpg", style = "width: 80px; height: 80px; border-radius: 50%; object-fit: cover;")
          ),
          tags$a(
            href = "https://isabellasegarra.github.io/", target = "_blank",
            tags$img(src = "isabella.jpg", style = "width: 80px; height: 80px; border-radius: 50%; object-fit: cover;")
          )
        )
      )
    ),
...
div(
  ...
  div(
    ...
    tags$button(
      ...
      style = "margin-top: 20px; padding: 12px 24px; font-size: 1.2rem;
